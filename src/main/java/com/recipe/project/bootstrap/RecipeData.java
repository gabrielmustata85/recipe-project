...
import com.recipe.project.model.*;
...
public class RecipeData implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public RecipeData(CategoryRepository categoryRepository, RecipeRepository recipeRepository, UnitOfMeasureRepository unitOfMeasureRepository) {
